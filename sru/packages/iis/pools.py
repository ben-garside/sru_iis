...
def get_all(**kw):
    ...
    try:
        ...
        message = "'pools/get_all' fialed with Exception: {}".format(e)
        msg.update({
            'message': message,
            'result': [],
            'code': 501
...
def get_by_name(**kw):
    ...
    try:
        ...
        message = "'pools/get_by_name' fialed with Exception: {}".format(e)
        msg.update({
            'message': message,
            'result': [],
            'code': 501
...
def get_by_pipelinemode(**kw):
    ...
    try:
        ...
        message = "'pools/get_by_PipelineMode' fialed with Exception: {}".format(e)
        msg.update({
            'message': message,
            'result': [],
            'code': 501
...
def get_by_state(**kw):
    ...
    try:
        ...
        message = "'pools/get_by_state' fialed with Exception: {}".format(e)
        msg.update({
            'message': message,
            'result': [],
            'code': 501
...
def get_by_site_id(**kw):
    ...
    try:
        ...
        message = "'pools/get_by_id' fialed with Exception: {}".format(e)
        msg.update({
            'message': message,
            'result': [],
            'code': 501
...
def stop_by_site_id(**kw):
    ...
    try:
        ...
        message = "'pool/stop_by_site_id' fialed with Exception: {}".format(e)
        msg.update({
                    'message': message,
                    'result': [],
                    'code': 501
...
def start_by_site_id(**kw):
    ...
    try:
        ...
        message = "'pool/start_by_site_id' fialed with Exception: {}".format(e)
        msg.update({
                    'message': message,
                    'result': [],
                    'code': 501
