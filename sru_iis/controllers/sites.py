...
def get_all(**kw):
    try:
        ...
        logger.error("'sites/get_all' fialed with Exception: {}".format(e))
...
def get_by_id(**kw):
    ...
    try:
        ...
        logger.error("'sites/get_by_id' fialed with Exception: {}".format(e))
...
def get_by_binding(**kw):
    ...
    try:
        ...
        logger.error("'sites/get_by_binding' fialed with Exception: {}".format(e))
...
def start_by_id(**kw):
    ...
    try:
        ...
        logger.error("'sites/start_by_id' fialed with Exception: {}".format(e))
...
def stop_by_id(**kw):
    ...
    try:
        ...
        logger.error("'sites/stop_by_id' fialed with Exception: {}".format(e))
...
def recycle_by_id(**kw):
    ...
    try:
        ...
        logger.error("'sites/recycle_by_id' fialed with Exception: {}".format(e))
